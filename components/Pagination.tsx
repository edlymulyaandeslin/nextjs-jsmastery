    ...
    <div className={cn("mt-5 flex w-full items-center justify-center gap-2", containerClasses)}>
      ...
      {Number(page) > 1 && (
        <Button
          ...
          className="light-border-2 btn flex min-h-[36] items-center justify-center gap-2 border"
        >
          <p className="body-medium text-dark300_light900">Prev</p>
        </Button>
      )}
      ...
      {isNext && (
        <Button
          ...
          className="light-border-2 btn flex min-h-[36] items-center justify-center gap-2 border"
        >
          <p className="body-medium text-dark300_light900">Next</p>
        </Button>
      )}
    </div>
  );
