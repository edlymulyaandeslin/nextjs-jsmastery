      ...
      <form className="flex w-full flex-col gap-10" onSubmit={form.handleSubmit(handleCreateQuestion)}>
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="flex w-full flex-col">
              ...
              <FormControl>
                <Input
                  className="paragraph-regular background-light700_dark300 light-border-2 text-dark300_light700 no-focus min-h-[56] border"
                  {...field}
                />
              </FormControl>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="flex w-full flex-col">
              <FormLabel className="paragraph-semibold text-dark400_light800">
                Detail explaination your problem <span className="text-primary-500">*</span>
              </FormLabel>
              <FormControl>
        ...
        <div className="mt-16 flex justify-end">
          <Button type="submit" className="primary-gradient text-light-900! w-fit cursor-pointer">
            Ask Question
          </Button>
        </div>
      </form>
